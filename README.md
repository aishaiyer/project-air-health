...
3. Which features (PM₂.₅ exposure, meteorology, seasonality) dominate model behavior, and with what uncertainty?

---

## Data Sources
- **Air Quality:** EPA Air Quality System (AQS) PM₂.₅ (daily, site-level)
